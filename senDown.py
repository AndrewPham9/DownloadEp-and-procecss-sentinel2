...
def Download_sentinel_2 (lowLeftLat,lowLeftLong,upRightLat,upRightLong,date):
    ...
    for result in results:
        ...
        urlDown = B[0:40]+A.split('/')[-3]+'/'+A.split('/')[-2]+'/STANDARD/EE'
...
def main ():
    ...
    result = Download_sentinel_2(args.lowLeftLong,args.lowLeftLat,args.upRightLong,args.upRightLat,args.date)
